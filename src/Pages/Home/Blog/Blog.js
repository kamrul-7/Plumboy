...
const Blog = () => {
    useTitle('Blog')
    return (
        <div className='text-start mb-8 mx-4 lg:mx-8 text-black mt-4'>

            <div className=' bg-white lg:p-8 p-4 shadow-lg hover:shadow-2xl rounded-md'>
            ...
            <div className=' bg-white p-8 shadow-lg hover:shadow-2xl mt-7 rounded-md'>
            ...
            <div className=' bg-white p-8 shadow-lg hover:shadow-2xl mt-8 rounded-md'>
